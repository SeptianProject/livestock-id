        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <ul style="list-style:none;padding:0;margin:0;">
                    ...
                    <li class="nav-item" style="margin-left: 20px;"><a href="../rekam-kesehatan/tindakan/index.php" class="nav-link-item"><i class="bi bi-droplet-half"></i><span>Tindakan</span></a></li>
