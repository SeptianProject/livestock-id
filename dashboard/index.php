...
<body>
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <ul style="list-style: none; padding: 0; margin: 0">
          ...
          <li class="nav-item">
            <a href="petugas/index.php" class="nav-link-item">
        ...
        <ul style="list-style: none; padding: 0; margin: 0">
          <li class="nav-item">
            <a href="rekam-kesehatan/index.php" class="nav-link-item">
              <i class="bi bi-heart-pulse"></i>
              <span>Rekam Kesehatan</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="catatan-produksi/index.php" class="nav-link-item">
      ...
      <div class="sidebar-footer">
        <a href="../auth/login.php" class="nav-link-item">
  ...
  <script>
    ...
    const data30 = [
      980, 1020, 1100, 1050, 1090, 1130, 1080, 1150, 1090, 1240, 1300, 1210,
      1240, 1190, 1280, 1320, 1200, 1170, 1250, 1300, 1280, 1310, 1190, 1220,
      1260, 1300, 1280, 1240, 1310, 1240,
    ];
