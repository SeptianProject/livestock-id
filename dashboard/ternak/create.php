    ...
    <div class="main-area">
      <header class="topbar">
        ...
        <div style="display: flex; align-items: center; gap: 8px; flex: 1">
          ...
          <span class="topbar-title" style="font-size: 15px">Tambah Ternak</span>
        </div>
          ...
          <div class="form-card">
            ...
            <div
              style="
                ...
                ">
              <div>
                <label class="form-label" for="idTernak">ID Ternak <span style="color: #e05252">*</span></label>
                <input
                  type="text"
                  id="idTernak"
                  name="id_ternak"
              ...
              <div>
                <label class="form-label" for="jenisTernak">Jenis Ternak <span style="color: #e05252">*</span></label>
                <select
                  id="jenisTernak"
                  name="jenis_ternak"
                  class="form-control-custom"
              ...
              <div>
                <label class="form-label" for="jenisKelamin">Jenis Kelamin <span style="color: #e05252">*</span></label>
                <select
                  id="jenisKelamin"
                  name="jenis_kelamin"
                  class="form-control-custom"
              ...
              <div>
                <label class="form-label" for="tanggalLahir">Tanggal Lahir <span style="color: #e05252">*</span></label>
                <input
                  type="date"
                  id="tanggalLahir"
                  name="tanggal_lahir"
              ...
              <div>
                <label class="form-label" for="warna">Warna / Ciri Fisik</label>
                <input
                  type="text"
                  id="warna"
                  name="warna"
            ...
            <div
              style="
                ...
                ">
              <div>
                <label class="form-label" for="idKandang">Kandang <span style="color: #e05252">*</span></label>
                <select
                  id="idKandang"
                  name="id_kandang"
                  class="form-control-custom"
              ...
              <div>
                <label class="form-label" for="statusKesehatan">Status Kesehatan Awal</label>
                <select
                  id="statusKesehatan"
